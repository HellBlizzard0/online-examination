...
public class Log4j extends Logger {
	...
	/**
	 * Trace Error Exception and write it into server .out file,custom .log file and send E-mail with error string, Context-Root must be written in log4j.properties file as # <context-root>Name Here</context-root>
	 * 
	 * @param cl
	 * @param ex
	 * @param msg
